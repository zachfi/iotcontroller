...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReconcilerStackEntry) DeepCopyInto(out *ReconcilerStackEntry) {
	*out = *in
	if in.Top != nil {
		in, out := &in.Top, &out.Top
		*out = new(ReconcilerStackTop)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReconcilerStackEntry.
func (in *ReconcilerStackEntry) DeepCopy() *ReconcilerStackEntry {
	if in == nil {
		return nil
	}
	out := new(ReconcilerStackEntry)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReconcilerStackTop) DeepCopyInto(out *ReconcilerStackTop) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReconcilerStackTop.
func (in *ReconcilerStackTop) DeepCopy() *ReconcilerStackTop {
	if in == nil {
		return nil
	}
	out := new(ReconcilerStackTop)
...
func (in *Remediation) DeepCopyInto(out *Remediation) {
	*out = *in
	...
	if in.ActiveComputeArgs != nil {
		in, out := &in.ActiveComputeArgs, &out.ActiveComputeArgs
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SunWindow) DeepCopyInto(out *SunWindow) {
	*out = *in
	out.Before = in.Before
	out.After = in.After
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SunWindow.
func (in *SunWindow) DeepCopy() *SunWindow {
	if in == nil {
		return nil
	}
	out := new(SunWindow)
...
func (in *TimeIntervalSpec) DeepCopyInto(out *TimeIntervalSpec) {
	*out = *in
	...
	if in.SunRelative != nil {
		in, out := &in.SunRelative, &out.SunRelative
		*out = make([]SunWindow, len(*in))
		copy(*out, *in)
	}
}
...
func (in *ZoneStatus) DeepCopyInto(out *ZoneStatus) {
	*out = *in
	if in.ReconcilerStack != nil {
		in, out := &in.ReconcilerStack, &out.ReconcilerStack
		*out = make([]ReconcilerStackEntry, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
