...
type Config struct {
	...
	ConditionerClient common.ClientConfig `yaml:"conditioner_client,omitempty"`
}
...
func (cfg *Config) RegisterFlagsAndApplyDefaults(prefix string, f *flag.FlagSet) {
	...
	cfg.ConditionerClient.RegisterFlagsAndApplyDefaults(util.PrefixConfig(prefix, "conditioner-client"), f)
}
