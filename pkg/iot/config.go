...
type MQTTConfig struct {
	...
	Username flagext.Secret `yaml:"username,omitempty"`
...
func (cfg *MQTTConfig) RegisterFlagsAndApplyDefaults(prefix string, f *flag.FlagSet) {
	...
	f.Var(&cfg.Username, util.PrefixConfig(prefix, "username"), "The username to authenticate with the MQTT broker")
	f.Var(&cfg.Password, util.PrefixConfig(prefix, "password"), "The password to authenticate with the MQTT broker")
